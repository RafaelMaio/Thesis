...
namespace GoogleARCore.Examples.PersistentCloudAnchors
{
    ...
    public struct CloudAnchorHistory
    {
        ...
        public CloudAnchorHistory(string name, string id, DateTime time, string prefab_name)
        {
        ...
        /// <param name="name">An informative name given by the user.</param>
        /// <param name="id">The Cloud Anchor Id which is used for resolving.</param>
        public CloudAnchorHistory(string name, string id, string prefab_name) : this(name, id, DateTime.Now, prefab_name)
        {
        }
