...
// PURPOSE     : Adapted from the ARCore application.
// SPECIAL NOTES:
// ===============================
...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DepthWithoutMenu : MonoBehaviour
    {
        /// <summary>
        ...
        public void Start()
        {
            ...
            {
                settingsMenuScript.depthNotAvailable();
                this.GetComponent<DepthWithoutMenu>().enabled = false;
                return;
            }
        ...
        public void Update()
        {
            ...
            if (Session.Status == SessionStatus.Tracking && settingsMenuScript.depth_enabled)
            {
